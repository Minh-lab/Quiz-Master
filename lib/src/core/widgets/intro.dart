...
class Intro extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _appBarIntro(Image.asset(AppAsset.topSplash2Image)),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            _contentIntro(
              "Edu Hub là ứng dụng luyện đề thi miễn phí dành cho các bạn học sinh THPT Sự hài lòng của bạn là niềm vui của tôiXin cảm ơn!",
            ),
          ],
        ),
      ),
  ...
  PreferredSize _appBarIntro(Image image) {
    return PreferredSize(
      ...
      child: AppBar(title: image, centerTitle: true),
    );
  }
