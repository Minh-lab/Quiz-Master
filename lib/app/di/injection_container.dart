...
import 'package:quiz_mater_apllication/src/features/subject_exem/domain/usecases/exams/get_exam_duration.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => GetExamDurationUsecase(repository: sl()));
